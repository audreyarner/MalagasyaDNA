...
MalagasyPCA <- read.table("ZanzibarfinalwithContemp.evec", col.names=c("Sample", "PC1", "PC2", "PC3", "PC4", "PC5","PC6", "PC7", "PC8", "PC9", "PC10", "Misc"))

Populations <- read.table("ZanzibarPopulations.txt")
...
ggsave(plot, file="ZanzibarPCAPlot.pdf", height=12, width=12)