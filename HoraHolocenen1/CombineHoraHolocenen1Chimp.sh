...
plink --bfile ../HoraHolocenen1Only --extract  ../HoraHolocenen1CombinedSNPs.txt --make-bed --out HoraHolocenen1Thin

plink --bfile ../../AfricanAsianMalagasyChimp --extract  ../HoraHolocenen1CombinedSNPs.txt --make-bed --out ContemporaryHoraHolocenen1Thin
...
plink --bfile final_tmp3 --bmerge HoraHolocenen1_flipped_tmp --must-have-sex --make-bed --out HoraHolocenen1finalwithChimp --chr 1-22

plink --bfile HoraHolocenen1finalwithChimp --recode vcf --out HoraHolocenen1ChimpforTreemix