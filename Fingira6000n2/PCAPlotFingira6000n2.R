...
MalagasyPCA <- read.table("Fingira6000n2finalwithContemp.evec", col.names=c("Sample", "PC1", "PC2", "PC3", "PC4", "PC5","PC6", "PC7", "PC8", "PC9", "PC10", "Misc"))

Populations <- read.table("Fingira6000n2Populations.txt")
...
ggsave(plot, file="Fingira6000n2PCAPlot.pdf", height=12, width=12)